...
namespace Web.Models
{
    public class PaginationViewModel
    {
        ...
        public int ItemsOnPage { get; set; } // her saydaki ürün sayısı
        public int TotalPages => (int)Math.Ceiling((double)TotalItems / Constants.ITEMS_PER_PAGE); //toplam sayfa sayısı (12/4)
        public bool HasPrevious => PageId > 1;  // sayda no 1den büyükse önceki vardır.
        public bool HasNext => PageId < TotalPages; // sayfa no toplam sayfa sayısından küçükse sonraki vardır.
